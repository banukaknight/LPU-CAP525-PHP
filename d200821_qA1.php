...
Value 1: <input type="text" name="val1" size="10" value= <? echo isset($_GET['val1']) ? $_GET['val1'] : '' ?> ><br />
Value 1: <input type="text" name="val2" size="10" value= <? echo (isset($_GET['val2']) ? $_GET['val2'] : ''); ?>  ><br />
